from torch import nn, ones, Size
import torch
...
#         # Feature extraction
#         self.conv11 = nn.Conv2d(bands_nb, 32, kernel_size=3, padding=1)
#         self.bn11 = nn.BatchNorm2d(32, track_running_stats=False)
#         self.conv12 = nn.Conv2d(32, 32, kernel_size=3, padding=1)
#         self.bn12 = nn.BatchNorm2d(32, track_running_stats=False)
#         self.conv13 = nn.Conv2d(32, 64, kernel_size=3, padding=1)
#         self.bn13 = nn.BatchNorm2d(64, track_running_stats=False)
#         self.conv14 = nn.Conv2d(64, 64, kernel_size=3, padding=1)
#         self.bn14 = nn.BatchNorm2d(64, track_running_stats=False)
#
#
#         # Stage 2
#         # Classifier
...
#
#         self.conv14d = nn.Conv2d(64, 64, kernel_size=3, padding=1)
#         self.bn14d = nn.BatchNorm2d(64, track_running_stats=False)
#         self.conv13d = nn.Conv2d(64, 32, kernel_size=3, padding=1)
#         self.bn13d = nn.BatchNorm2d(32, track_running_stats=False)
#         self.conv12d = nn.Conv2d(32, 32, kernel_size=3, padding=1)
#         self.bn12d = nn.BatchNorm2d(32, track_running_stats=False)
#         self.conv11d = nn.Conv2d(32, bands_nb, kernel_size=3, padding=1)
#
#     def forward(self, x):
#
